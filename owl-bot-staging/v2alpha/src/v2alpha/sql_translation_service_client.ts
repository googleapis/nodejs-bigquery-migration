 ...
 * `src/v2alpha/sql_translation_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './sql_translation_service_client_config.json';
 ...
 * @memberof v2alpha
 */
export class SqlTranslationServiceClient {
  ...
  sqlTranslationServiceStub?: Promise<{[name: string]: Function}>;
  ...
  initialize() {
    ...
    if (this.sqlTranslationServiceStub) {
      return this.sqlTranslationServiceStub;
    }
 ...
 *   The first element of the array is an object representing {@link google.cloud.bigquery.migration.v2alpha.TranslateQueryResponse | TranslateQueryResponse}.
 *   Please see the
 ...
 */
  ...
  translateQuery(
    ...
    this.initialize();
    return this.innerApiCalls.translateQuery(request, options, callback);
  }
   ...
   */
  close(): Promise<void> {
    if (this.sqlTranslationServiceStub && !this._terminated) {
      return this.sqlTranslationServiceStub.then(stub => {
