...
describe('v2alpha.MigrationServiceClient', () => {
    ...
    describe('createMigrationWorkflow', () => {
        it('invokes createMigrationWorkflow without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow());
    ...
    describe('getMigrationSubtask', () => {
        it('invokes getMigrationSubtask without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.migration.v2alpha.MigrationSubtask());
