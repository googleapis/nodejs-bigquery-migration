...
describe('v2.MigrationServiceClient', () => {
    ...
    describe('createMigrationWorkflow', () => {
        it('invokes createMigrationWorkflow without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.migration.v2.CreateMigrationWorkflowRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.migration.v2.MigrationWorkflow());
            ...
            assert((client.innerApiCalls.createMigrationWorkflow as SinonStub)
    ...
    describe('getMigrationWorkflow', () => {
        it('invokes getMigrationWorkflow without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.migration.v2.GetMigrationWorkflowRequest());
            request.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getMigrationWorkflow as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteMigrationWorkflow', () => {
        it('invokes deleteMigrationWorkflow without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.migration.v2.DeleteMigrationWorkflowRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteMigrationWorkflow as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('startMigrationWorkflow', () => {
        it('invokes startMigrationWorkflow without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.migration.v2.StartMigrationWorkflowRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.startMigrationWorkflow as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getMigrationSubtask', () => {
        it('invokes getMigrationSubtask without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.migration.v2.GetMigrationSubtaskRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.bigquery.migration.v2.MigrationSubtask());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getMigrationSubtask as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listMigrationWorkflows', () => {
        it('invokes listMigrationWorkflows without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.migration.v2.ListMigrationWorkflowsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listMigrationWorkflows as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listMigrationSubtasks', () => {
        it('invokes listMigrationSubtasks without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.migration.v2.ListMigrationSubtasksRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listMigrationSubtasks as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
